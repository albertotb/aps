...
ggsave(p, filename = "img/aps_prob3.eps", device = "eps", dpi = 300)
...
ggsave(p, filename = "img/EU_probtime.eps", device = "eps", dpi = 300)
...
ggsave(p, filename = "img/costs.eps", device = "eps", dpi = 300)
...
ggsave(p, filename = "img/pa_given_d.eps", device = "eps", dpi = 300)
