...
if [[ -z "$1" || "$1" == "mcmc" ]]; then
    ...
    qsub -N "mcmc_adg_3" -o $d/prob3_mcmc_adg.out -j y ./run_exp.sh -p prob3 -a mcmc -s adg -o $d --mcmc 10000
...
if [[ -z "$1" || "$1" == "aps" ]]; then
    ...
    #qsub -N "aps_adg_3" -o $d/prob3_aps_adg.out -j y ./run_exp.sh -p prob3 -a aps  -s adg -o $d --aps  10000000 --aps_inner 1000000
fi
